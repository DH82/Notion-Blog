      ...
      <Html lang={CONFIG.lang}>
        <Head>
          ...
          {CONFIG.googleAdsense?.enable === true &&
            CONFIG.googleAdsense.config.publisherId && (
              <script
                async
                src={`https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=${CONFIG.googleAdsense.config.publisherId}`}
